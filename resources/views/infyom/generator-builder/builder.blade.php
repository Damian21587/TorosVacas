...
<script>
    ...
    $(function () {
        ...
        $(document).ready(function () {
            ...
            var commonComponent = $(htmlStr).filter("tr").load('{{ route('admin.infyOmGenerator.io_field_template') }}');
            var relationStr = '<tr class="relationItem" style="display: table-row;"></tr>';
            var relationComponent = $(relationStr).filter("tr").load('{{ route('admin.infyOmGenerator.io_relation_field_template') }}');
            ...
            $("#form").on("submit", function () {
                ...
                $.ajax({
                    url: '{{ route('admin.infyOmGenerator.io_generator_builder_generate') }}',
                   // type: "POST",
                    method: "POST",
                    dataType: 'json',
            ...
            $('#rollbackForm').on("submit", function (e) {
                ...
                $.ajax({
                    url: '{{ route('admin.infyOmGenerator.io_generator_builder_rollback') }}',
                    method: "POST",
                    dataType: 'json',
                    contentType: 'application/json',
                    data: JSON.stringify(data),
            ...
            $('#schemaForm').on("submit", function (e) {
                ...
                $.ajax({
                    url: '{{ route('admin.infyOmGenerator.io_generator_builder_generate_from_file') }}',
                    type: 'POST',
